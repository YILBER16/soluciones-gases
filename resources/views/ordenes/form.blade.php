                         ...
                         <div class="row">
                            <div class="col-xs-6 col-sm-6 col-md-6">
                               <div class="form-group">
                                ...
                                value="{{isset($ultimoAgregadosumado)?$ultimoAgregadosumado:old('Id_produccion')}}" placeholder="No. Orden" class="form-control {{$errors->has('Id_produccion')?'is-invalid':''}} "maxlength="11" minlength="1" onkeypress="return validarNumero(event)" readonly>
