    ...
    <div class="container ">
                        ...
                        <div class="form-group d-flex justify-content-center">
                            <div class="input-group col-md-8">
                              ...
                              <button class="btn btn-primary" type="button" disabled="disabled"> <span><i class="fas fa-home"></i></span> </button>
                                ...
                                value="{{isset($user->email)?$user->email:old('email')}}" placeholder="email" class="form-control {{$errors->has('email')?'is-invalid':''}}">
                         ...
                         <div class="form-group d-flex justify-content-center">
                            <div class="input-group col-md-8">
                              ...
                              <button class="btn btn-primary" type="button" disabled="disabled"> <span><i class="fas fa-phone"></i></span> </button>
                                ...
                                <input id="password" name="password" type="password" value="{{isset($user->password)?$user->password:old('password')}}" placeholder="password" class="form-control {{$errors->has('password')?'is-invalid':''}}">
                        ...
                        <div id="user_permissions_box">
                          <div id="user_permissions_checkbox_list">
                            ...
                            <label class="custom-control-label" for="{{$permission->slug}}">{{$permission->name}}
                            </label>
                            </div>
                            @endforeach
                          </div>
